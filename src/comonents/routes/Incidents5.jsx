...
<div className=' w-[250px]  '>
 ...
 <div className='flex justify-between mt-10 md:mt-0 gap-[14px] '>
   ...
   <div className='md:w-[752px] md:h-[589px] gap-6 mb-20  absolute md:left-[440px] md:top-[220px]'>
    <div className='w-[700px] h-[75px]'>
      <h1 className='text-black text-[24px] font-[700] h-[31px]'>Where’s the incident?</h1>
      <p className='text-Primary w-[420px] md:w-[518px] leading-[22px] text-[16px] font-[400] mt-3'>Enter a GPS, address. or pin point on the map. Try to be as accurate as possible, or click:Jurisdiction Wide</p>
...
<div className='  items-center  gap-[14px]   mt-6'>
        ...
        <input className='w-full' type="text" placeholder='Pinpoint damage'  />
         ...
         <img className='rounded-[6px] w-[430px] h-[430px] md:w-full md:h-full  ' src="./img/map.png" alt="Card Image" />
         </div>
