...
const HandalerClick=()=>{
  ...
  return (
   ...
   <>
   <Navbar/>
   <nav className="md:w-[1269px]  md:mt-2 mt-64  p-4 flex flex-col font-Onest  md:flex-row justify-between items-center border-t-2 md:gap-4">
   ...
   <div className='md:w-[753px] h-[445px] mt-[40px] font-Onest gap-[25px] absolute md:left-[410px] md:top-[220px]'>
    <h1 className='text-[24px] font-[700] text-dashcolor'>Which of these best describes the incident?</h1>
   
    <div className="md:w-[753px] h-[389px] md:gap-[8px] grid grid-cols-2 mt-4 md:flex  md:flex-wrap">
      {images.map((data) => (
        <div
          key={data.id}
          className=" w-[150px] md:w-[180px] h-[69px] rounded-[6px] md:gap-[10px] px-2 hover:bg-secondary border-[1px] md:flex md:justify-normal md:items-center"
        >
          <div className='mt-2'>
          {data.image}
          </div>
